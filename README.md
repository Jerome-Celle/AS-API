...
[![Build Status](https://travis-ci.com/jerome/jerome/artsouterrain.svg?branch=develop)](https://travis-ci.com/jerome/jerome/artsouterrain)
...
```
git clone https://github.com/jerome/artsouterrain.git
```
